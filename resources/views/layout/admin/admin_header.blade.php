<nav class=" container-fluid navbar navbar-expand-lg pt-4 pb-5 px-3">
    ...
    <div>
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <form class="d-flex nav-button">
                <button class="btn-outline me-2" type="submit" >Dashboard</button>
                ...
                {{--                @endif--}}
                <button class="btn btn-violet" type="submit" formaction="{{ url('/api/logout') }}">Logout</button>
            </form>
        </div>
    </div>
</nav>
